...
public class MockHttpServletRequest implements HttpServletRequest {
	...
	public Map<String, String[]> getHeaders() {
		...
		for (Object obj : this.headers.entrySet()) {
	...
	public javax.servlet.http.Part getPart(String name) throws java.io.IOException, javax.servlet.ServletException {
		throw new UnsupportedOperationException("getPart not supported in mock");
	}

	@Override
	public java.util.Collection<javax.servlet.http.Part> getParts() throws java.io.IOException, javax.servlet.ServletException {
		throw new UnsupportedOperationException("getParts not supported in mock");
	}
	...
	@Override
	public boolean authenticate(javax.servlet.http.HttpServletResponse response) throws javax.servlet.ServletException, java.io.IOException {
		return false;
	}
	...
	public javax.servlet.AsyncContext startAsync() {
		throw new UnsupportedOperationException("startAsync not supported in mock");
	}
