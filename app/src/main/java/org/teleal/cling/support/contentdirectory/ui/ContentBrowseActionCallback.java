...
public abstract class ContentBrowseActionCallback extends Browse {
	...
	public ContentBrowseActionCallback(Service service, TreeModel treeModel, TreeNode treeNode) {
		super(service,
			treeNode.getUserObject() instanceof org.teleal.cling.support.model.container.Container
				? ((org.teleal.cling.support.model.container.Container)treeNode.getUserObject()).getId()
				: "0",
			org.teleal.cling.support.model.BrowseFlag.DIRECT_CHILDREN);
